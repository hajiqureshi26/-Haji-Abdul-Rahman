...
<head>
    ...
    <meta name="description" content="Haji Abdul Rahman's Personal Webpage">
    <title>Haji Abdul Rahman | Portfolio</title>
    <style>
        body {
        ...
        body {
             background-image: url("https://assets.onecompiler.app/42t5s2n9q/42tdw4ghe/quantum.webp");
